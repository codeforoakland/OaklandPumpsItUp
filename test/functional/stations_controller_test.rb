...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, description: @station.description, latitude: @station.latitude, longitude: @station.longitude, name: @station.name, station_type: @station.station_type }
    end
  ...
  test "should update station" do
    put :update, id: @station, station: { address: @station.address, description: @station.description, latitude: @station.latitude, longitude: @station.longitude, name: @station.name, station_type: @station.station_type }
    assert_redirected_to station_path(assigns(:station))
  end
